...
var mapquestOSM = L.tileLayer("http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png", {
  maxZoom: 19,
  attribution: 'Tiles courtesy of <a href="http://www.openstreetmap.org/" target="_blank">OpenStreetMap</a>. Map data (c) <a href="http://www.openstreetmap.org/" target="_blank">OpenStreetMap</a> contributors, CC-BY-SA.'
});
...
$.getJSON(location.origin + "/percorsi.geojson", function (data) {
...
var theaters = L.geoJson(null, {
  pointToLayer: function (feature, latlng) {
    ...
    return L.marker(latlng, {
      icon: L.icon({
        iconUrl: "../static/images/theater.png",
        iconSize: [24, 28],
        iconAnchor: [12, 28],
        popupAnchor: [0, -25]
      }),
    ...
    */
      if (feature.properties.status == 'PI') {
          var iconOpt = {icon: plannedMarker};
          return L.marker(latlng, iconOpt);
      } else {
  ...
  onEachFeature: function (feature, layer) {
    if (feature.properties) {
      var content = "<table class='table table-striped table-bordered table-condensed'>" + "<tr><th>Nome</th><td>" + feature.properties.nome + "</td></tr>" + "<tr><th>Status</th><td>" + feature.properties.status + "</td></tr>" + "<tr><th>Descrizione</th><td>" + feature.properties.descrizione + "</td></tr>" + "<tr><th>Degrado</th><td><a class='url-break' href='" + feature.properties.degrado + "' target='_blank'>" + feature.properties.degrado + "</a></td></tr>" + "<table>";
      layer.on({
        click: function (e) {
...
$.getJSON("/punti.geojson", function (data) {
...
var museums = L.geoJson(null, {
  pointToLayer: function (feature, latlng) {
    return L.marker(latlng, {
      icon: L.icon({
        iconUrl: "static/images/museum.png",
        iconSize: [24, 28],
        iconAnchor: [12, 28],
        popupAnchor: [0, -25]
      }),
...
attributionControl.onAdd = function (map) {
  ...
  div.innerHTML = "<span class='hidden-xs'>Developed by <a href='https://rusti.cc'>fradeve</a> | </span><a href='#' onclick='$(\"#attributionModal\").modal(\"show\"); return false;'>Attribution</a>";
  return div;
};
...
var baseLayers = {
  "Mappa OSM": mapquestOSM,
  "Strade": mapquestHYB
};

var groupedOverlays = {
  "Punti di interesse": {
    "<img src='../static/images/theater.png' width='24' height='28'>&nbsp;Interventi": theaterLayer/*,
  ...
  */
  {
    ...
    templates: {
      header: "<h4 class='typeahead-header'><img src='../static/images/theater.png' width='24' height='28'>&nbsp;Interventi</h4>",
      suggestion: Handlebars.compile(["{{name}}<br>&nbsp;<small>{{address}}</small>"].join(""))
    }
